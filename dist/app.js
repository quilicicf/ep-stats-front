...
var author$project$Main$computeRequestUrl = F2(
	function (range, apiKey) {
		return A2(
			lukewestby$elm_string_interpolate$String$Interpolate$interpolate,
			'https://sheets.googleapis.com/v4/spreadsheets/19eKYnYjibyZ2syrr66g4-gR6SIgF_pCHjUWWYiqSpJg/values/{0}?key={1}',
			_List_fromArray(
				[range, apiKey]));
	});
		...
		elm$http$Http$get(
			{
				...
				url: A2(author$project$Main$computeRequestUrl, 'Titans!A%3AAZ', 'tooSensitiveToShare')
			}));
};
...
var author$project$Main$LoadingFailure = {$: 'LoadingFailure'};
...
var author$project$Main$update = F2(
	function (msg, model) {
		...
		if (result.$ === 'Ok') {
			...
			return _Utils_Tuple2(author$project$Main$LoadingFailure, elm$core$Platform$Cmd$none);
		}
	});
...
var author$project$Main$view = function (model) {
	switch (model.$) {
		case 'LoadingFailure':
			return elm$html$Html$text('I was unable to load your sheet.');
		case 'Loading':
