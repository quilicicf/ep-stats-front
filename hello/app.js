...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {at: fragment, av: host, aE: path, aG: port_, aK: protocol, aL: query};
	});
...
var author$project$Main$main = elm$browser$Browser$application(
	{bc: author$project$Main$init, bh: author$project$Main$UrlChanged, bi: author$project$Main$LinkClicked, br: author$project$Main$subscriptions, bu: author$project$Main$update, bw: author$project$Main$view});
